 ...
 */
public class BigQueryTornadoes2 {
    private static final Logger LOG = LoggerFactory.getLogger(BigQueryTornadoes2.class);
    ...
    /**
     * Options supported by {@link BigQueryTornadoes2}.
     *
    ...
    public interface Options extends PipelineOptions {
        ...
        @Default.String("fair-catcher-384714.cloudtest.test3")
        @Validation.Required
        String getOutput();
